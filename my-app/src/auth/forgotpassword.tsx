    ...
    <div className="bg-white  h-full items-center">
      <Box padding={10} textAlign={"center"}>
        ...
        <form className="flex flex-col items-center gap-8 *:w-100">
          <Text color={"primary"}>
            A code would be sent to your email to help reset your password
          </Text>
          <div>
            <HStack>
              <Icon position={"absolute"} marginLeft={3} fontSize={"20px"}>
                <Email />
              </Icon>
              <Input placeholder="Email" paddingLeft={10} h={12} w={"full"} />
            </HStack>
          </div>
          <Button
            colorPalette={"#ffe170"}
